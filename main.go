...
// Функция должна генерировать числа и записывать их в канал ch. Для каждого числа должна быть вызвана функция fn().
...
func main() {
	...
	// а при её завершении — wg.Done(). Используйте анонимную функцию
	// с двумя параметрами go func(in <-chan int64, i int64){},
	// где in  — очередной канал из outs, а i — его индекс.
